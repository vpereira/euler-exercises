...
inverse_rows = [list(reversed(i)) for i in rows]
inverse_columns = [list(reversed(i)) for i in columns]
products = []

products.append(calculate_horizontal(rows))
products.append(calculate_horizontal(columns))
products.append(calculate_diagonal(rows))
products.append(calculate_diagonal(inverse_rows))
products.append(calculate_horizontal(inverse_rows))
products.append(calculate_horizontal(inverse_columns))
